 ...
 */
public class offer_46_LastRemaining_Solution {
    ...
    public static void main(String[] args) {
        offer_46_LastRemaining_Solution test = new offer_46_LastRemaining_Solution();
        System.out.println(test.LastRemaining_Solution(8,1));
    }
}
