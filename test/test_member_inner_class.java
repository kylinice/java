...
public class test_member_inner_class {
    ...
    class Inner {
        ...
        void inner_f1() {
            ...
            System.out.println(test_member_inner_class.this.j);
    ...
    public static void outer_f4() {
        // step1 建立外部类对象
        test_member_inner_class out = new test_member_inner_class();
    ...
    public static void main(String[] args) {
        ...
        // 那就不需要对其外围类对象的引用。
        test_member_inner_class out = new test_member_inner_class();
        test_member_inner_class.Inner outin = out.new Inner();
        outin.inner_f1();
    }
}
